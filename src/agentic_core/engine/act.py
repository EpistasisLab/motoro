...
from agentic_core.services.llm_errors import LLMBudgetExceededError
from agentic_core.services.llm_service import LLMService

if TYPE_CHECKING:
    from agentic_core.mcp.adapters import ToolExecutionError
...
class ActPhase:
    ...
    async def _execute_single_step(
        ...
        corrupt the set.
        """
        from agentic_core.mcp.adapters import (
            MCPToolExecutor,
            build_openai_tool_name_map,
            tools_to_openai_format,
        )
        from agentic_core.schemas.llm import PlanStep as _PlanStep
