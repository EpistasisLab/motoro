...
from agentic_core.engine.act import SUPPRESS_FINAL_SYNTHESIS_KEY
...
from agentic_core.engine.patterns.prompts.reason_act import (
...
from agentic_core.schemas.patterns.reason_act import (
    ReasonActAction,
...
class ReasonActPlugin(PatternPlugin):
    ...
    async def _persist_state(self, context: RunContext) -> None:
        ...
        try:
            ...
            from agentic_core.models.run import AgentRun
    ...
    async def _pre_act(self, context: RunContext, _output: BaseModel | None) -> BaseModel | HookAction | None:
        ...
        from agentic_core.mcp.adapters import build_openai_tool_name_map, tools_to_openai_format
