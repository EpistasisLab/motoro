...
The table is still written — see :func:`motoro.services.pattern_catalog.
...
if TYPE_CHECKING:
    from motoro.engine.patterns.base import PatternPlugin
    from motoro.schemas.pattern import (
        PatternConfig,
...
def validate_pattern_config(config: PatternConfig | dict[str, Any] | None) -> PatternConfigValidationResult:
    ...
    """
    from motoro.engine.patterns import composition
    from motoro.schemas.pattern import (
        PatternConfig,
